<div class="footer h-full">
  <div class="grid md:grid-cols-3 gap-4 justify-items-center">
      ...
      <div class="w-full m-top2">
        ...
        <span class="block pb-6 text-center reveal2"> <a class ="hover:text-yellow-700"  href=""><i class="fab fa-facebook-f fa-2x"></i></a> </span>
        <span class="block pb-6 text-center reveal2"> <a class ="hover:text-yellow-700"  href=""><i class="fab fa-instagram  fa-2x"></i></a> </span>
        <span class="block pb-6 text-center reveal2"> <a class ="hover:text-yellow-700"  href=""><i class="fab fa-whatsapp   fa-2x"></i></a> </span>
