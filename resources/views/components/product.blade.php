<div class="product m-top3">
    ...
    <div class="mt-10 pt-5">
        <h1 class="text-3xl md:text-5xl text-center font-extrabold uppercase tracking-tight  second-text-color  reveal2">
            I nostri Prodotti
        </h1>
    </div>
    <!-- zafferano ---------------------------------------------------------------------------------------------------------------------  -->
    ...
    <div class="mb-8">
        <div
            ...
            <div class="pr-2 pl-2">
                <h2 class="text-2xl font-extrabold uppercase tracking-tight  mt-5 text-[#870058]  reveal2">
                    Zafferano di Montagna</h2>
                <p class="pb-5 text-[25px] leading-10 font-light  text-gray-500 reveal2">
            ...
            <div class="grid grid-cols-1 grid-rows-2  md:mt-8 mb-4 gap-2 sm:gap-6 lg:gap-y-2">
                ...
                <img src="/img/tris-pack-zoom.jpg" loading="lazy" alt="zafferano-di-montagna"
                    class="bg-gray-100 rounded-lg  mt-4 mx-auto   zoom">
            ...
            <dl
                ...
                <div class="border-t border-gray-400 pt-4 pb-4">
                    <dt class="font-medium text-gray-900">Confezione</dt>
                    <dd class="mt-2 text-sm text-gray-500">Acquista una confezione regalo con <br> nastro e paglietta
                        &nbsp;
                        1€</dd>
                </div>
            </dl>
        ...
        <div
            class="grid grid-cols-1 gap-y-16 gap-x-8 max-w-2xl mx-auto py-10 px-4 items-center lg:max-w-7xl lg:px-8 lg:grid-cols-4 md:border-t md:border-b md:border-gray-400">
            <div class="">
        ...
        <div
            class="max-w-2xl mx-auto px-4 grid grid-cols-1  gap-y-8 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
            <div class="pr-2 pl-2">
                <h2 class="text-3xl font-extrabold uppercase tracking-tight text-[#870058]  reveal2">
                    Miele & Zafferano</h2>
                <p class=" pb-5 text-[25px] leading-10 font-light  text-gray-500 reveal2">
            ...
            <dl
                ...
                <div class="border-t border-gray-400 pt-4 reveal2">
                    <dt class="font-medium text-gray-900">Prezzi</dt>
                    <dd class="mt-2 text-sm text-gray-500">
                        <span class="w-12 border border-transparent">Vasetto da 250g</span> <span
                ...
                <div class="border-t border-gray-400 pt-4 reveal2">
                    ...
                    <dd class="mt-2 text-sm text-gray-500">
                        <span class="w-12 border border-transparent">Aceto di Mele 250ml</span> <span
                            class="w-12 border border-transparent">€ &nbsp; 5.00 </span> <br>
                    </dd>
                </div>
                <div class="border-t border-gray-400 pt-4 pb-4">
                    <dt class="font-medium text-gray-900">Confezione</dt>
